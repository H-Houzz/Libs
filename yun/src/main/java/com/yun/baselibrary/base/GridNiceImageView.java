...
public class GridNiceImageView extends AppCompatImageView {
    ...
    public GridNiceImageView(Context context) {
        this(context, null);
    }

    public GridNiceImageView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GridNiceImageView(Context context, AttributeSet attrs, int defStyleAttr) {
