...
public class GridItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private GridItemDecoration(int horizonSpan,int verticalSpan,int color,boolean showLastLine,boolean style) {
...
//            //满足条件( 最后一行 && 不绘制 ) 将vertical多出的一部分去掉;
    ...
    public void getItemOffsets(Rect outRect, View view, RecyclerView parent, RecyclerView.State state) {
        if(!style){
            ...
            if (childAdapterPosition != 0) {
                outRect.set(0, mHorizonSpan, 0, 0);
            }
            return;
        }
    ...
    public static class Builder {
         ...
         * 是否是grid样式
         * */
        public Builder setGridStyle(boolean style){
            this.style = style;
            return this;
        }
        ...
        public GridItemDecoration build() {
            return new GridItemDecoration(mHorizonSpan, mVerticalSpan, mColor,mShowLastLine,style);
        }
    }
}
